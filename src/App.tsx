import { FormHandlerProvider, SiteDataProvider } from '@spektra/runtime'
...
import { createBcFormHandler } from './data/create-form-handler'

const adapter = createAdapter()
const formHandler = createBcFormHandler()
